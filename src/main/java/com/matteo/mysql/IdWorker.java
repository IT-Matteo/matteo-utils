...
public class IdWorker {
    ...
    public static String UserSqlId() {
        return String.valueOf(new IdWorker(IdUser.USER.getWorkerId(), IdUser.USER.getDatacenterId()).nextId());
    }

    public static String AdminSqlId() {
        return String.valueOf(new IdWorker(IdUser.ADMIN.getWorkerId(), IdUser.ADMIN.getDatacenterId()).nextId());
    }

    public static String VideoSqlId() {
